...
CREATE TABLE `administrador` (
  ...
  `nombre_usuario` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
...
INSERT INTO `cliente` VALUES (2,5),(29,46),(30,47);
...
CREATE TABLE `domicilio` (
  ...
  `calle` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `altura` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `localidad` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `partido` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
...
INSERT INTO `domicilio` VALUES (12,'Rincón ','564','San Fernando','San Fernando','Buenos Aires',14),(23,'25 de mayo','400','San Isidro','San Isidro','Buenos Aires',26),(24,'av. San Martin','123','Caseros','Tres de Febrero','Buenos Aires',31),(27,'Dr. Rebizzo','1515','Caseros','Tres de Febrero','Buenos Aires',34);
...
INSERT INTO `prestador` VALUES (3,10),(4,18);
...
INSERT INTO `reserva` VALUES (24,2,'2024-10-10 15:00:00','2024-10-10 17:00:00',70000,10,29);
...
INSERT INTO `sala` VALUES (9,1,40000,14),(10,2,35000,14),(25,3,250000,14),(26,4,50000,14),(36,1,25000,31),(37,2,25000,31),(38,3,35000,31),(39,4,25000,31),(40,1,251000,26),(49,1,250000,34),(51,2,150000,34);
...
CREATE TABLE `sucursal` (
  ...
  `telefono` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
...
INSERT INTO `sucursal` VALUES (14,'\"Lo de Sergio\" Studio',4,3,'12:00:00','23:00:00','02222222222'),(26,'\"Lo de Sergio\" Studio 2 - San Isidro',2,3,'10:00:00','22:00:00','02222222222'),(31,'\"Lo de Sergio\" Studio 3',4,3,'09:00:00','23:00:00','02222222222'),(34,'\"Lo de Sergio\" FAKE',3,4,'10:00:00','23:00:00','12121212');
...
CREATE TABLE `usuario` (
  ...
  `password` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `celular` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `rol` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
...
-- Dump completed on 2024-10-02 17:13:48
